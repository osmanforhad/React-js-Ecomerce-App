                            ...
                            <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4 form-group mb-3">
                                        ...
                                        <input type="checkbox" name="featured" onChange={handleInput} value={productInput.featured} className="w-100 h-50" />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Popular (check=shown)</label>
                                        <input type="checkbox" name="popular" onChange={handleInput} value={productInput.popular} className="w-100 h-50" />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Status (check=hidden)</label>
                                        <input type="checkbox" name="status" onChange={handleInput} value={productInput.status} className="w-100 h-50" />
                                    </div>
                                </div>
