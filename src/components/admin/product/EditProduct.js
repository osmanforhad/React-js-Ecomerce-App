...
function EditProduct(props) {
    ...
    if (loading) {
        return <h4>Loading... Product Info</h4>
    }
                        ...
                        <div className="tab-content" id="myTabContent">
                            ...
                            <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Featured (check=shown)</label>
                                        <input type="checkbox" name="featured" onChange={handleCheckbox} defaultChecked={allcheckbox.featured === 1 ? 'true' : false} className="w-100 h-50" />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Popular (check=shown)</label>
                                        <input type="checkbox" name="popular" onChange={handleCheckbox} defaultChecked={allcheckbox.popular === 1 ? 'true' : false} className="w-100 h-50" />
                                    </div>
                                    <div className="col-md-4 form-group mb-3">
                                        <label>Status (check=hidden)</label>
                                        <input type="checkbox" name="status" onChange={handleCheckbox} defaultChecked={allcheckbox.status === 1 ? 'checked' : false} className="w-100 h-50" />
                                    </div>
                                </div>
