...
function ProductDetail(props) {
    ...
    useEffect(() => {
        ...
        const category_slug = props.match.params.categories;
    ...
    }, [props.match.params.categories, props.match.params.product, history]);

    //Quantity Decerement / Increment in Hooks -Start
    ...
    //Quantity Decerement / Increment in Hooks -End
        ...
        <div>
            <div className="py-3 bg-warning">
                <div className="container">
                    <h6>Collections / {product.categories.name} / {product.name}</h6>
                </div>
            </div>
            <div className="py-3">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-8">
                            <h4>
                                {product.name}
                                <span className="float-end badge btn-sm btn-danger badage-pil">{product.brand}</span>
                            </h4>
